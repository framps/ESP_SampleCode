...
7. findSensors: The functionality was added to findDevices.sh located in [this repository](https://github.com/framps/raspberryTools) and is available with option `-d e`.
